...
suite('Functional Tests', function() {
    ...
    test('Convert a valid input such as 10L: GET request to /api/convert', (done) => {
        chai
            ...
            .end((err, res) => {
                ...
                assert.equal(res.text, '{"initNum":10,"initUnit":"L","returnNum":2.64172,"returnUnit":"gal","string":"10 liters converts to 2.64172 gallons"}','Response should be "{"initNum":10,"initUnit":"L","returnNum":2.64172,"returnUnit":"gal","string":"10 liters converts to 2.64172 gallons"}"')
                done();
            });
    })
    ...
    test('Convert with no number such as kg: GET request to /api/convert.', (done) => {
        chai
            ...
            .end((err, res) => {
                assert.equal(res.status, 200, 'Response status should be 200')
                assert.equal(res.text, '{"initNum":1,"initUnit":"kg","returnNum":2.20462,"returnUnit":"lbs","string":"1 kilograms converts to 2.20462 pounds"}', 'Response should be "{"initNum":1,"initUnit":"kg","returnNum":2.20462,"returnUnit":"lbs","string":"1 kilograms converts to 2.20462 pounds"}"')
                done();
            });
    })
});
